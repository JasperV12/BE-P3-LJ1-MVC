        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SmartphoneController/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="geheugen" type="number" min="0" max="4000" class="form-control" id="geheugen" value="<?= $_POST['geheugen'] ?? $data['smartphone']->Geheugen ?>">
                </div>
                <div class="mb-3">
                ...
                <!-- Hidden veld voor het ID (uit afbeelding 14) -->
